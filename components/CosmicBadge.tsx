...
export default function CosmicBadge({ bucketSlug }: CosmicBadgeProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 text-sm font-medium text-gray-800 no-underline transition-colors duration-200 hover:bg-gray-50"
      style={{
        position: 'fixed',
